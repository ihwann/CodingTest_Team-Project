...
<div style="width:60%;margin:auto;">
	...
	<form action="uploadReview" method="POST">
		...
		<br>
		<br>
		<input type="text" class="text-style"  style="width:800px" name="review_title" placeholder="제목을 입력하세요" value="<%=review.getReview_title() %>"><br><br>
	    
	    <textarea id="message" class="text-style" name="review_content" rows="20" cols="120" placeholder="내용을 입력해주세요 "><%=review.getReview_content() %></textarea>
	    <br><br>
